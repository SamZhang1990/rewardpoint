package com.iv.rewardpoint.user.controller;
...
import com.iv.rewardpoint.user.service.UserService;
...
public class UserController {
	...
	public Result findAll() {
		return new Result(true, StatusCode.OK, "查询成功, serverPort:" + serverPort, userService.findAll());
	}
